...
const contractList = [
  ...
  },
  {
    ...
    omitted: ['invented question, signal, owner or due date', 'Roadmap capacity and bet resolution'],
    confirmation: 'Complete every generated decision before treating the starter as a decision plan.',
  ...
  },
  {
    ...
    omitted: ['unselected branches', 'unresolved work', 'dormant or moot decisions', 'Paths decision receipts'],
