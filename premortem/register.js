...
/* First-run seed so premortem greets with a populated, EV-ranked register instead
   ...
   Fictional Lantern reading app — no real products. p in %, impact in £k, both 90%
...
export function exampleDoc(){
  ...
  return {v: 1, id: 'example-lantern', title: 'Lantern 2.0 launch',
    question: "It's launch + 90 days and Lantern 2.0 flopped. Why?",
    ...
    entries: [
      ...
      risk('Offline downloads become a wholesale library copy', [20, 40], [20, 70]),
